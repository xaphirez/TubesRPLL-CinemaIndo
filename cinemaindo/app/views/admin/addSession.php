                        ...
                        <div class="container">
                            <form action="<?= BASEURL; ?>/admin/addSession" method="POST">
                                ...
                                <div class="mb pt-1">
                                    ...
                                    <input type="text" class="form-control" id="tanggal_mulai" name="tanggal_mulai" placeholder = "YY/MM/DD" required>
                                </div>
                                <div class="mb pt-1">
                                    <label for="nama" class="form-label">Tanggal Selesai</label>
                                    <input type="text" class="form-control" id="tanggal_selesai" name="tanggal_selesai" placeholder = "YY/MM/DD" required>
                                </div>
                                <div class="mb pt-1">
                                    <label for="nama" class="form-label">Waktu Mulai</label>
                                    <input type="text" class="form-control" id="waktu_mulai" name="waktu_mulai" placeholder = "Masukkan Jam Mulai" required>
                                </div>
                                <div class="mb pt-1">
                                    <label for="nama" class="form-label">Waktu Selesai</label>
                                    <input type="text" class="form-control" id="waktu_selesai" name="waktu_selesai" placeholder = "Masukkan Jam Selesai" required>
                                </div>
                                <div class="mb pt-1">
                                    <label for="nama" class="form-label">Harga</label>
                                    <input type="text" class="form-control" id="harga" name="harga" placeholder = "Masukkan Jam Harga" required>
                                </div>
