            ...
            <div class="col-md-8 pt-5">
                <div class="card bg-dark text-light" style="border-radius: 1rem;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                <img src="data:image/jpeg;base64,<?php echo base64_encode($data['film']['gambar']); ?>" class="card-img" alt="<?php echo $data['film']['nama_film']; ?>">
                            </div>
                            <div class="col-md-8">
                        ...
                        <div class="text-center pt-3 pb-1">
                            <a href="<?php echo $link_kembali; ?>" class="btn-color btn btn-primary btn-block fa-lg gradient-custom-2 mb-3">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
